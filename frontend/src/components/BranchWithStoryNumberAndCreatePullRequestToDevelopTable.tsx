...
import './BranchWithStoryNumberAndCreatePullRequestToDevelopTable.css';
...
export const BranchWithStoryNumberAndCreatePullRequestToDevelopTable: React.FC = () => {
...
export default BranchWithStoryNumberAndCreatePullRequestToDevelopTable;