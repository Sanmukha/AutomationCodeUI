...
export const DashboardTable: React.FC = () => {
	...
	const [q, setQ] = useState<Record<string,string>>({"sector":"","profit":"","lossRange":"","datePurchased":""});
